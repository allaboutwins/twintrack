      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 24px 80px" }}>
        ...
        <div style={{ color: "#333", lineHeight: 1.75, fontSize: 15 }}>
          <Section title="Who We Are">
            ...
            <p>Contact: <a href="mailto:privacy@allaboutwins.com" style={{ color: "#e91e8c" }}>privacy@allaboutwins.com</a></p>
          </Section>
          ...
          <Section title="Your Rights">
            ...
            <p>To exercise these rights, email <a href="mailto:privacy@allaboutwins.com" style={{ color: "#e91e8c" }}>privacy@allaboutwins.com</a>.</p>
          ...
          <Section title="Children's Privacy">
            <p>TwinTrack is designed for use by adults (parents and caregivers). We do not knowingly collect information from children under 13. If you believe a child under 13 has created an account, contact us at <a href="mailto:privacy@allaboutwins.com" style={{ color: "#e91e8c" }}>privacy@allaboutwins.com</a> and we will delete it promptly.</p>
          </Section>
          ...
          <Section title="Contact">
            <p>
              ...
              Email: <a href="mailto:privacy@allaboutwins.com" style={{ color: "#e91e8c" }}>privacy@allaboutwins.com</a><br />
        ...
        <div style={{ marginTop: 40, paddingTop: 24, borderTop: "1px solid #f0f0f0", textAlign: "center" }}>
          ...
          <a href="mailto:privacy@allaboutwins.com" style={{ color: "#888", fontSize: 14, textDecoration: "none" }}>Contact Us</a>
        </div>
      </div>
    </div>
  );
